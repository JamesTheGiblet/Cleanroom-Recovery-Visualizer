...
* [ ] **Custom Configuration:** Allow users to save their specific room dimensions and HVAC profiles to LocalStorage.
* [ ] **PDF Reporting:** Generate "Incident Recovery Reports" for compliance documentation (Audit Trail).
...
* [ ] **Energy Optimization:** Calculate the *cost* of recovery (HVAC energy spend) vs. speed.
